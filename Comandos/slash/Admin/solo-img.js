        ...
        interaction.reply({
            embeds: [
                new EmbedBuilder()
                    ...
                    .setDescription('El canal seleccionado eliminará lo que son textos, links, comandos, etc. El bot auditará que solo se pongan imágenes.')
            ],
            components: [
                new ActionRowBuilder().addComponents(
                    new StringSelectMenuBuilder()
                        .setCustomId(`OnlyIMG_${interaction.user.id}`)
